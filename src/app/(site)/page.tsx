...
const bannerSlides = [
  { type: "poster", title: "青马工程", subtitle: "学生干部素质拓展活动", badge: "2026年机械工程学院", org: "大连交通大学 · 机械工程学院团委" },
  { type: "countdown", title: "距离活动开始", badge: "倒计时" },
  { type: "announcement", title: "最新公告", content: "2026年青马工程学生干部素质拓展活动报名已开启，请各班班委登录网站确认报名信息！", badge: "公告" },
];
              ...
              {currentSlide === 0 ? (
                <div className="relative z-10">
                  ...
                  >
                    ...
                    <span className="text-white/90 text-xs font-medium">2026年机械工程学院</span>
                  </motion.div>
                  <motion.h1
                ...
                <div className="relative z-10">
                  ...
                  <h2 className="text-2xl font-bold text-white mb-4">活动报名已开启</h2>
                  <p className="text-white/70 text-sm leading-relaxed max-w-xs mx-auto mb-6">2026年青马工程学生干部素质拓展活动报名已开启，请各班班委登录网站确认报名信息！</p>
        ...
        <div className="relative z-10 px-4 pb-3">
          <div className="bg-white/[0.08] backdrop-blur-2xl rounded-2xl p-3 border border-white/[0.08]">
            <div className="grid grid-cols-5 gap-0.5">
              {functionGrid.map((item, i) => (
                <Link key={item.href} href={item.href} className="flex flex-col items-center gap-1 py-1.5 active:scale-90 transition-transform">
      ...
      <section className="hidden lg:flex relative min-h-screen items-center justify-center overflow-hidden">
        ...
        >
          ...
          >
            ...
            <span className="text-white/90 text-sm font-medium tracking-wide">2026年机械工程学院</span>
          </motion.div>
      ...
      <section className="hidden lg:block py-3 bg-red-50/80 border-y border-red-100/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-3">
            ...
            <p className="text-gray-600 text-sm truncate flex-1">2026年青马工程学生干部素质拓展活动报名已开启，请各班班委登录网站确认报名信息！</p>
